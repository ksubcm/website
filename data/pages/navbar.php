...
<div class="container">
<div class="editable" style=""><p>Edit the textbox below to change the links in the navbar above.</p>
...
<?php global $conf; echo file_get_contents($conf['CONFPATH']."/navbar.conf"); ?>
  </textarea>
